...
# image_processor = AutoImageProcessor.from_pretrained(img_model_checkpoint, cache_dir=cache_dir)
...
#     logging_dir="./logs/finetune-resnet3",  # TensorBoard 日志存放路径
...
feature_extractor = AutoFeatureExtractor.from_pretrained(audio_model_name, cache_dir=cache_dir)
